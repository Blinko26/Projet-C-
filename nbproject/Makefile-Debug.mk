...
# Test Object Files
TESTOBJECTFILES= \
	${TESTDIR}/tests/siRicheTest.o \
	${TESTDIR}/tests/siRicheTestRunner.o
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/siRicheTest.o ${TESTDIR}/tests/siRicheTestRunner.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS}   `cppunit-config --libs`   


${TESTDIR}/tests/siRicheTest.o: tests/siRicheTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/siRicheTest.o tests/siRicheTest.cpp


${TESTDIR}/tests/siRicheTestRunner.o: tests/siRicheTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/siRicheTestRunner.o tests/siRicheTestRunner.cpp
