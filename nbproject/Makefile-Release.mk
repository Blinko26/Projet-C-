...
${TESTDIR}/tests/siRicheTest.o: tests/siRicheTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/siRicheTest.o tests/siRicheTest.cpp


${TESTDIR}/tests/siRicheTestRunner.o: tests/siRicheTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/siRicheTestRunner.o tests/siRicheTestRunner.cpp
